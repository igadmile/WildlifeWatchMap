...
wwwMap.basemaps = {
    dof: L.tileLayer.wms('http://geoportal.dgu.hr/wms', {
        layers: 'DOF',
        format: 'image/jpeg',
        attribution: wwwMap.additional_attrib2
    }),
    tk25: L.tileLayer.wms('http://geoportal.dgu.hr/wms', {
        layers: 'TK25',
        format: 'image/jpeg',
        attribution: wwwMap.additional_attrib2
    }),
    osm: L.tileLayer('http://{s}.tile.thunderforest.com/landscape/{z}/{x}/{y}.png', {
    ...
    wwwMap.baseMaps = [
        {
            ...
            expanded: true,
            layers: {
                'Thunderforest Landscape': wwwMap.basemaps.osm,
                'Topographic map': wwwMap.basemaps.tk25,
                'Digital orthophoto': wwwMap.basemaps.dof
            }
        }
    ];
    wwwMap.overlays2 = [
    ...
    wwwMap.baseMaps = [
        {
            ...
            layers: {
                'Thunderforest Landscape': wwwMap.basemaps.osm,
                'Topografska karta': wwwMap.basemaps.tk25,
                'Digitalni ortofoto': wwwMap.basemaps.dof
            }
        }
    ];
    wwwMap.overlays2 = [
